        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DesiredPrice = table.Column<decimal>(type: "decimal(11,2)", nullable: false),
                    Currency = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StartsAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndsAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    LowestBidderId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LowestBidAmount = table.Column<decimal>(type: "decimal(11,2)", nullable: true),
